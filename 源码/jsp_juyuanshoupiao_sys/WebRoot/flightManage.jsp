      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="#">演出管理<span class="sr-only">(current)</span></a></li>
            <li><a href="airPlaneManage.jsp">演出团队管理</a></li>
          </ul>
          <ul class="nav nav-sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">当前共有${flightListLength}演出</h2>
          <div class="table-responsive">
            ...
            <button type="button" class="btn btn-lg btn-success" onclick="javascript:window.location.href='addFlight.jsp';">新增演出</button>
          </div>
        </div>
      </div>
    </div>
