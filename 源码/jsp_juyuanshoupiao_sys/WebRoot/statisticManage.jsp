    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <form class="form-inline" action="statisticManage.jsp">
			  <div class="form-group">
			    <label for="exampleInputName2">团队</label>
			    <input type="text" class="form-control" id="exampleInputName1" placeholder="团队" name="start">
			  </div>
