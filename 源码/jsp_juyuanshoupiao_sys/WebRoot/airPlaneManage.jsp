<%@page import="pers.gulo.fm.domain.AirPlane"%>
...
<%
	...
	List<AirPlane> airPlanesList=aService.listAllAirPlane();
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="flightManage.jsp">演出管理 </a></li>
            <li class="active"><a href="#">演出团队管理<span class="sr-only">(current)</span></a></li>
          </ul>
          <ul class="nav nav-sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">当前共有${airPlanesListLength}演出团队</h2>
          <div class="table-responsive">
			...
			<c:forEach var="a" items="${airPlanesList}">
				 <tr>
                  ...
                  <td><c:out value="${a.model}"/></td>
                  <td><c:out value="${a.capacity}"/></td>
                  <td>
            ...
            <button type="button" class="btn btn-lg btn-success" onclick="javascript:window.location.href='addAirPlane.jsp';">新增演出团队</button>
          </div>
        </div>
      </div>
    </div>
